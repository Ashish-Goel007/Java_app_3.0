...
def jfrogUpload() :
    ...
    url = 'http://192.168.29.133:8082/artifactory/example-repo-local/kubernetes-configmap-reload-0.0.1-SNAPSHOT.jar'
    file_path = '/var/lib/jenkins/workspace/my-test-pipeline/target/kubernetes-configmap-reload-0.0.1-SNAPSHOT.jar'
    username = 'admin'
    password = 'Password@123' #replace 'your password with ur actual password'
